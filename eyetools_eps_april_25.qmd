...
::: {.column}
![](github_ss.png){width="800"}
:::

::: {.column}
![](documentation.png){width="800"} 
...
fix <- fixation_dispersion(data, min_dur = 100)
...
## Example use of AOI_seq()

![](seq_AOI_dist_anim.gif)
