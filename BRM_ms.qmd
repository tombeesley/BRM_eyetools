...
| Package       | Hardware-agnostic | Imports           | Processes        | Identifies events  | Plots             | Analyses         |
|:-------------:|:-----------------:|:-----------------:|:----------------:|:------------------:|:-----------------:|:----------------:|
| eyetools      | {{< fa check >}}  | {{< fa check >}}* | {{< fa check >}} | {{< fa check >}}   | {{< fa check >}}  |                  |
| eyeTrackr     |                   | {{< fa check >}}  | {{< fa check >}} |                    |                   | {{< fa check >}} |
| eyelinker     |                   | {{< fa check >}}  |                  |                    |                   |                  |
| eyelinkReader |                   | {{< fa check >}}  |                  |                    | {{< fa check >}}  |                  |
| eyeRead       | {{< fa check >}}  |                   | {{< fa check >}} | {{< fa check >}}** |                   | {{< fa check >}} |
