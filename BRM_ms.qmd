...
In addition to the packages listed in the above table, there are several packages on CRAN that are well equipped to handle pupilomtery data processing: eyeris; 
