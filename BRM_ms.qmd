...
The eyetools functionality hinges upon data being formatted with trial numbers, timestamps, and x and y coordinates. The optional extra column of participant ID (unneeded when working with data from a single participant) enables researchers to work with large, multi-participant datasets without needing to deploy complex
