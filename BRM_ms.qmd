...
Eyetools is open source software that is therefore free to use and open to further development. We have created this package for use in analyses in our own laboratory, as well as applying it to other other experimental data. However, our testing of the functions is not extensive, given the unfunded nature of the project. Below we list the
