...
\abstract{Eye data analysis has become an integral part of data analysis
in the psychological sciences. Here we introduce eyetools, an R package
that provides an open source means of conducting eye data analysis.
eyetools is aimed at researchers who may not have experience programming
their own eye data analysis routines. The package provides a number of
functions that facilitate key steps in the pipeline of eye data
analysis, from basic data processing, extraction of fixations and
saccades, to trial level statistics, and data visualisation. In this
article we introduce these critical features of the package and provide
a step-by-step guide which will enable researchers to find open source
...
drawn periods of 10 seconds. Figure Figure~\ref{fig-tobii-comp} shows
