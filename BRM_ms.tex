...
eyetools is designed primarily for use by experimental psychologists and
is aimed at researchers who may be initially reticent about programming
their own eye data analysis routines. It handles basic data processing,
extraction of fixations and saccades, a variety of analysis steps, and
data visualisation. In this paper we introduce the critical features of
the package.}
