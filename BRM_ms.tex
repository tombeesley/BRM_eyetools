...
Goldberg (\citeproc{ref-salvucci2000}{2000})). The period in which the
...
\pandocbounded{\includegraphics[keepaspectratio]{BRM_ms_files/figure-pdf/unnamed-chunk-15-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{BRM_ms_files/figure-pdf/unnamed-chunk-16-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{BRM_ms_files/figure-pdf/unnamed-chunk-17-1.pdf}}

The \texttt{plot\_AOI\_growth()} function offers a visualisation of how
an individual (on a single trial) spends their time looking at the
different AOIs. This can be useful to see how AOIs are interacted with
over time, and this can be presented as either a plot of the cumulative
time, or as a proportion of the time spent in the trial.
...
\texttt{plot\_heatmap()} which takes raw data as an input. Like
...
Eyetools is open source software that is therefore free to use and open
to further development. We have created this package for use in analyses
in our own laboratory, as well as applying it to other other
experimental data. However, our testing of the functions is not
extensive, given the unfunded nature of the project. Below we list the
